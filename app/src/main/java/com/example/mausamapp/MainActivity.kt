...
// 91296a7f202097399ba42b1f540fa6b9
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName:String){
        ...
        val response= retrofit.getWeatherData(cityName,"91296a7f202097399ba42b1f540fa6b9","metric")
        response.enqueue(object : Callback<MausamApp2> {
            override fun onResponse(call: Call<MausamApp2>, response: Response<MausamApp2>) {
            ...
            override fun onFailure(call: Call<MausamApp2>, t: Throwable) {
